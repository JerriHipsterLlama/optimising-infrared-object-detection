...
Usage:
    # From run directory
    python scripts/reporting/plot_faster_rcnn_metrics.py --run artifacts/checkpoints/faster_rcnn/train

    # From metrics file
    python scripts/reporting/plot_faster_rcnn_metrics.py --metrics artifacts/checkpoints/faster_rcnn/train/metrics.json

    # Save plots to custom location
    python scripts/reporting/plot_faster_rcnn_metrics.py --run artifacts/checkpoints/faster_rcnn/train --output plots/
"""
